    ...
    <div class="d-flex">
        ...
        <nav class="sidebar">
            ...
            <div class="nav flex-column">
                <a class="nav-link {{ request()->routeIs('supplier.dashboard') ? 'active' : '' }}" href="{{ route('supplier.dashboard') }}">
                    <i class="fas fa-tachometer-alt me-2"></i>
                    Dashboard
                </a>
                
                <a class="nav-link {{ request()->routeIs('supplier.medicines*') ? 'active' : '' }}" href="{{ route('supplier.medicines') }}">
                ...
                <a class="nav-link {{ request()->routeIs('supplier.reports*') ? 'active' : '' }}" href="{{ route('supplier.reports.inventory') }}">
